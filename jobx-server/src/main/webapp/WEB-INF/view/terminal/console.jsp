...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/static/css/jobx.term.css?resId=${resourceId}" >
    ...
    <script src="${contextPath}/static/js/jobx.term.js?resId=${resourceId}" type="text/javascript" ></script>
    <script type="text/javascript" src="${contextPath}/static/js/jobx.js?resId=${resourceId}"></script>

    <title>jobx Terminal</title>
</head>
    ...
    <div class="container">
        <div>
            <ul class="nav navbar-nav">
                <li><a class="term-logo" href="${contextPath}" target="_blank" title="">jobx</a></li>
...
<script type="text/javascript">
    $(document).ready(function () {
       document.title = unEscapeHtml('${name}');
        jobxTerm =  new JobXTerm('${token}','${theme}');
        //去掉a点击时的虚线框
        ...
        $(".theme").find("a").click(function () {
            jobxTerm.theme($(this).attr("theme"));
        });

    ...
    <div class="block-area" id="defaultStyle">
        ...
        <div>
            ...
            <div style="float: right;margin-top: -10px">
                ...
                <input type="text" id="sendTime" name="sendTime" value="${sendTime}" onfocus="WdatePicker({onpicked:function(){doUrl(); },dateFmt:'yyyy-MM-dd'})" class="Wdate select-jobx" style="width: 90px"/>
            ...
            <c:forEach var="log" items="${pageBean.result}" varStatus="index">
                <tr>
                    ...
                    <td class="text-center">
                            <a href="${contextPath}/notice/detail/${log.logId}.htm" title="查看详情">
        ...
        <cron:pager href="${contextPath}/notice/view.htm?agentId=${agentId}&sendTime=${sendTime}" id="${pageBean.pageNo}" size="${pageBean.pageSize}" total="${pageBean.totalCount}"/>

        ...
        <table class="table tile">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" style="width: 90px" id="startTime" name="startTime" value="${startTime}" onfocus="WdatePicker({onpicked:function(){},dateFmt:'yyyy-MM-dd'})" class="Wdate select-jobx"/>
                    <label for="endTime" class="label-self">&nbsp;至&nbsp;</label>
                    <input type="text" style="width: 90px" id="endTime" name="endTime" value="${endTime}" onfocus="WdatePicker({onpicked:function(){},dateFmt:'yyyy-MM-dd'})" class="Wdate select-jobx"/>&nbsp;

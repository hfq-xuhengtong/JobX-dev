...
public class RecordBean {
    ...
    public static Function<? super Record, ? extends RecordBean> transfer = new Function<Record, RecordBean>() {
        @Override
        public RecordBean apply(Record input) {
            return new RecordBean(input);
        }
    };

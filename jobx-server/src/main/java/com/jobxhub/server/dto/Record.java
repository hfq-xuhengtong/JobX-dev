...
public class Record implements Serializable {
    ...
    public static Function<? super RecordBean, ? extends Record> transfer = new Function<RecordBean, Record>() {
        @Override
        public Record apply(RecordBean input) {
    ...
    public Record(RecordBean record){
